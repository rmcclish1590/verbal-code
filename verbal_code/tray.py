...
class SystemTray:
    ...
    def __init__(
        ...
        on_logging: Callable[[], None] | None = None,
    ...
    def start(self) -> None:
        ...
        if self._on_logging:
            logging_item = self._gtk.MenuItem(label="Logging...")
            logging_item.connect("activate", self._on_logging_clicked)
    ...
    def _on_logging_clicked(self, _widget: Any) -> None:
        if self._on_logging:
            self._on_logging()
