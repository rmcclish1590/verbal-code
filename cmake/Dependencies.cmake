...
# Evdev (available on all Linux — no external deps, just kernel headers)
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    set(EVDEV_HOTKEY_AVAILABLE TRUE)
    message(STATUS "Evdev hotkey service available (Linux)")
else()
    set(EVDEV_HOTKEY_AVAILABLE FALSE)
endif()

# GIO (for portal hotkey service — usually comes with GTK3/GLib)
pkg_check_modules(GIO gio-2.0)
if(GIO_FOUND)
    message(STATUS "Found GIO: ${GIO_VERSION}")
    set(PORTAL_HOTKEY_DEPS_FOUND TRUE)
else()
    message(WARNING "GIO not found. Portal hotkey service will not build.")
    set(PORTAL_HOTKEY_DEPS_FOUND FALSE)
endif()
